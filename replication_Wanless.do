...
//Separates values for States performing above national average in education.
// Column 7
//tsset agencynum year
//ivreg `i' (gpolice_asg=gpolice_ucr) gpop_ucr gpop_asg y1-y51 [aw=popweight] if grad_dummy==1, robust
...
//Separates values for States performing at or below national average in education.
// Column 7
//tsset agencynum year
//ivreg `i' (gpolice_asg=gpolice_ucr) gpop_ucr gpop_asg y1-y51 [aw=popweight] if grad_dummy==0, robust
