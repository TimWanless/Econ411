//imports data
import delimited C:\Users\Timothy\Documents\MSAE\MSAE-Spring2020\ECON\dataverse_files\chalfin_mccrary_edited2.csv
//import delimited C:\Users\Timothy\Documents\MSAE\MSAE-Spring2020\ECON\dataverse_files\chalfin_mccrary_stat.csv
...
// %%%%%%%%%%%%%%%%%
// LEAST SQUARES for Below National Educational Attainment Average Dummy Variable Group
// %%%%%%%%%%%%%%%%%
...
// Column 1
areg `i' gpolice_ucr gpop_ucr gpop_asg [aw=popweight] if grad_dummy==0, absorb(year) robust

// Column 2
areg `i' gpolice_ucr gpop_ucr gpop_asg [aw=popweight]if grad_dummy==0, absorb(styr) robust

// Column 3
areg `i' gpolice_asg gpop_ucr gpop_asg [aw=popweight]if grad_dummy==0,  absorb(year) robust

// Column 4
areg `i' gpolice_asg gpop_ucr gpop_asg [aw=popweight]if grad_dummy==0, absorb(styr) robust

}


// %%%%%%%%%%%%%%%%%
// LEAST SQUARES for At or Above National Educational Attainment Dummy Variable Group
// %%%%%%%%%%%%%%%%%
tsset agencynum year
...
// Column 1
areg `i' gpolice_ucr gpop_ucr gpop_asg [aw=popweight] if grad_dummy==1, absorb(year) robust

// Column 2
areg `i' gpolice_ucr gpop_ucr gpop_asg [aw=popweight]if grad_dummy==1, absorb(styr) robust

// Column 3
areg `i' gpolice_asg gpop_ucr gpop_asg [aw=popweight]if grad_dummy==1,  absorb(year) robust

// Column 4
areg `i' gpolice_asg gpop_ucr gpop_asg [aw=popweight]if grad_dummy==1, absorb(styr) robust

}


// %%%%%%%%%%%%%%%%%
// LEAST SQUARES for Base Group
// %%%%%%%%%%%%%%%%%
tsset agencynum year
...
//2sls for Below National Educational Attainment Average Dummy Variable Group
// Column 5
//ivreg `i' (gpolice_ucr=gpolice_asg) gpop_ucr gpop_asg y1-y51 [aw=popweight] if grad_dummy==0, robust

// Column 6 
//tsset styr cityyr
//xtivreg2 `i' (gpolice_ucr=gpolice_asg) gpop_ucr gpop_asg [aw=popweight] if grad_dummy==0, fe robust


//2sls for At or Above National Educational Attainment Average Dummy Variable Group
// Column 5
//ivreg `i' (gpolice_ucr=gpolice_asg) gpop_ucr gpop_asg y1-y51 [aw=popweight] if grad dummy==1, robust

// Column 6
//tsset styr cityyr
//xtivreg2 `i' (gpolice_ucr=gpolice_asg) gpop_ucr gpop_asg [aw=popweight] if grad dummy==1, fe robust

// REFLECTED 2sls for Base Group
foreach i of varlist  ///
gviolent gmurder grape grobbery gassault ///
gproperty gburglary glarceny gmotor { 
...
//Reflected 2sls for At or Above National Educational Attainment Average Dummy Variable Group
// Column 7
//tsset agencynum year
//ivreg `i' (gpolice_asg=gpolice_ucr) gpop_ucr gpop_asg y1-y51 [aw=popweight] if grad_dummy==1, robust

// Column 8
//tsset styr cityyr
//xtivreg2 `i' (gpolice_asg=gpolice_ucr) gpop_ucr gpop_asg [aw=popweight] if grad_dummy==1, fe robust



//Reflected 2sls for Below National Educational Attainment Average Dummy Variable Group
// Column 7
//tsset agencynum year
//ivreg `i' (gpolice_asg=gpolice_ucr) gpop_ucr gpop_asg y1-y51 [aw=popweight] if grad_dummy==0, robust



// Column 8
//tsset styr cityyr
//xtivreg2 `i' (gpolice_asg=gpolice_ucr) gpop_ucr gpop_asg [aw=popweight] if grad_dummy==0, fe robust
...
// %%%%%%%% WEB APPENDIX %%%%%%%%
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
use chalfin_mccrary_restat.raw, clear
